...
echo "                    http://127.0.0.1:8686 by default (set WEB_HOST=0.0.0.0 for LAN)"
...
echo ""
echo "First run: sign in to the web UI with the access token from"
echo "  $DATA_DIR/config.json  (field \"auth_token\"), or set the SS_TOKEN env var."
echo ""
